...
def play():
    ...
    histoire2 = Tk()
    histoire2.geometry ("1280x720")
    histoire2.minsize (1280, 720)
    histoire2.maxsize (1280, 720)
    histoire2.rowconfigure(0, weight=1)
    histoire2.columnconfigure(0, weight=1)
    ...
    frame1 = Frame(histoire2, bg='#98A4FF')
    frame2 = Frame(histoire2, bg='#98A4FF')
    frame3 = Frame(histoire2, bg='#98A4FF')
    frame4 = Frame(histoire2, bg='#98A4FF')
    frame5 = Frame(histoire2, bg='#98A4FF')
    frame6 = Frame(histoire2, bg='#98A4FF')
    frame7 = Frame(histoire2, bg='#98A4FF')
    frame8 = Frame(histoire2, bg='#98A4FF')
    ...
    file = open("Histoire2/chapitre1.txt", "r")
    text1 = file.read()
    texte2 = text1.split("#")
    ...
    file = open("Histoire2/chapitre2.txt", "r")
    text1 = file.read()
    texte2 = text1.split("#")
    ...
    file = open("Histoire2/chapitre3.txt", "r")
    text1 = file.read()
    texte2 = text1.split("#")
    label= Label(frameq, text=texte2[0], font=("Courrier.tff", 20))
    label.pack(pady=10)
    ...
    file = open("Histoire2/chapitre4.txt", "r")
    text1 = file.read()
    texte2 = text1.split("#")
    label= Label(frameq, text=texte2[0], font=("Courrier.tff", 20))
    label.pack(pady=10)
    ...
    file = open("Histoire2/chapitre5.txt", "r")
    text1 = file.read()
    texte2 = text1.split("#")
    label= Label(frameq, text=texte2[0], font=("Courrier.tff", 20))
    label.pack(pady=10)
    ...
    file = open("Histoire2/message.txt", "r")
    text1 = file.read()
    texte2 = text1.split("#")
