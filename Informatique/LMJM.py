...
#texte2
titre2 = Label(frame_1, text="Es-tu prêt à créer ta propre Histoire ?", font=("Courrier.tff", 30), fg='#000000', relief="flat")
titre2.pack()
...
#Boutton Lancer une partie
c = Button(frameH2, text="Histoire 2", font=("Courrier.tff", 25), command=lambda:[Editor2.Story2(), showframe(frame1)])
c.pack(padx=10, pady=10)
