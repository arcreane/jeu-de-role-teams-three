...
def play():
    ...
    histoire1 = Tk()
    histoire1.geometry ("1280x720")
    histoire1.minsize (1280, 720)
    histoire1.maxsize (1280, 720)
    histoire1.rowconfigure(0, weight=1)
    histoire1.columnconfigure(0, weight=1)



    #Les Frames

    frame1 = Frame(histoire1, bg='#98A4FF')
    frame2 = Frame(histoire1, bg='#98A4FF')
    frame3 = Frame(histoire1, bg='#98A4FF')
    frame4 = Frame(histoire1, bg='#98A4FF')
    frame5 = Frame(histoire1, bg='#98A4FF')
    frame6 = Frame(histoire1, bg='#98A4FF')
    frame7 = Frame(histoire1, bg='#98A4FF')
    frame8 = Frame(histoire1, bg='#98A4FF')
