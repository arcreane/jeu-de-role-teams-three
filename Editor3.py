...
def Story3():
    ...
    editor3 = Tk()
    editor3.geometry("1280x720")
    editor3.minsize(1280, 720)
    editor3.maxsize(1280, 720)

    editor3.rowconfigure(0, weight=1)
    editor3.columnconfigure(0, weight=1)

    def showframe(frame):
        frame.tkraise()

    # Les Frames
    frame1 = Frame(editor3, bg='#98A4FF')
    frame2 = Frame(editor3, bg='#98A4FF')
    frame3 = Frame(editor3, bg='#98A4FF')
    frame4 = Frame(editor3, bg='#98A4FF')
    frame5 = Frame(editor3, bg='#98A4FF')
    frame6 = Frame(editor3, bg='#98A4FF')
    frame8 = Frame(editor3, bg='#98A4FF')
    frame11 = Frame(editor3, bg='#98A4FF')

    for frame in (frame1, frame2, frame4, frame4, frame5, frame6, frame8, frame11):
    ...
    # Texte Crée perso
    label_subtitle = Label(frame_1, text="Crée ta propre Histoire", font=("Courrier.tff", 40), fg='#000000',
                           relief="flat")
    ...
    def genre():
        ...
        file = open("Histoire3/genre.txt", "a")
        file.write(f"{genre}#")
        file.close()
    ...
    # Bouton Valider
    c = Button(frame_1, text="Valider", font=("Courrier.tff", 20), bg='#FFFFFF', fg='#000000',
               command=lambda: [perso(), genre(), showframe(frame11)])
    c.pack(pady=20, expand=YES)

    # Quitter
    c = Button(frame1, text="Menu Principal", font=("Courrier.tff", 12), bg='#FFFFFF', fg='#000000',
               command=stop)
    c.pack(side=BOTTOM)
    ...
    def chap1():
        ...
        choix1 = choix1_1.get()
        choix2 = choix1_2.get()
        file = open("Histoire3/chapitre1.txt", "a")
    ...
    # Quitter
    c = Button(frame2, text="Menu Principal", font=("Courrier.tff", 12), bg='#FFFFFF', fg='#000000',
               command=stop)
    c.pack(side=BOTTOM)
    ...
    def chap2():
        ...
        file = open("Histoire3/chapitre2.txt", "a")
    ...
    def chap3():
        ...
        file = open("Histoire3/chapitre3.txt", "a")
    ...
    # Quitter
    c = Button(frame4, text="Menu Principal", font=("Courrier.tff", 12), bg='#FFFFFF', fg='#000000',
               command=stop)
    c.pack(side=BOTTOM)
    ...
    def chap4():
        ...
        file = open("Histoire3/chapitre4.txt", "a")
    ...
    # Quitter
    c = Button(frame5, text="Menu Principal", font=("Courrier.tff", 12), bg='#FFFFFF', fg='#000000',
               command=stop)
    c.pack(side=BOTTOM)
    ...
    def chap5():
        ...
        file = open("Histoire3/chapitre5.txt", "a")
    ...
    # --------------------Fin--------------------#
    label_subtitle = Label(frame_8, text="Bravo, tu as fini ton Histoire !", font=("Courrier.tff", 40), fg='#000000',
                           relief="flat")
    label_subtitle.pack(side=TOP)
    label_subtitle = Label(frame_8, text="Est tu prês à la tester ?", font=("Courrier.tff", 40), fg='#000000',
                           relief="flat")
    label_subtitle.pack(side=TOP)
    ...
    # Quitter
    c = Button(frame11, text="Menu Principal", font=("Courrier.tff", 12), bg='#FFFFFF', fg='#000000',
               command=stop)
    c.pack(side=BOTTOM)
